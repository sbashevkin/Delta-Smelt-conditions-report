...
(ref:Temperature) Mean summer water temperature from discrete measurements collected by the STN, EMP, and EDSM surveys, shaded by suitability for Delta Smelt (bottom blue section under 20 &deg;C = good, middle yellow section between 20 and 22 &deg;C  = OK, top red section over 22 &deg;C = bad). Gray shading represents the standard deviation across all measurements from the summer of each year. Vertical dotted lines represent years with missing data.
